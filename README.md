...
- Right-click on the mesh in the main asset explorer and click `Export Mesh Files`. Use the file select pop-up to navigate into the desired output folder and click `Open`. All the res files belonging to the selected mesh will be exported to this location.  
**OR**
